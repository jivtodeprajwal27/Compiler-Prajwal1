...
SimType = NumType | BoolType | StringType | ListType | VarType
...
AST = NumLiteral | BoolLiteral | BinOp | IfElse | StringLiteral | StringOp|ListLiteral|ListOp| Get | Put |Let | LetConst |Seq | Whilethen
